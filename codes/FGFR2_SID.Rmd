...
```{r}
load("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/FM_FGFR2_coalterations.RData")
onco_data_new = R.utils::loadToEnv("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/FM_FGFR2_vars.RData")[["onco_data_new"]]
...
SLIPPER_SIP = xlsx::read.xlsx2("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/Human SIP-direct_interaction-v20121201.xlsx", startRow = 2, sheetIndex = 1, header = T) %>%
...
uniprot_prot = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/uniprot-filtered-organism__Homo+sapiens+(Human)+[9606]_+AND+review--.tab", header = T, sep = "\t", stringsAsFactors = F,
...
PPIDM = read.csv2("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/PPIDM_FullSortedDataset_84K_GSB.csv", sep = ",", stringsAsFactors = F, header = T)
...
threedid = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/3did_flat", header = F, sep = ",", stringsAsFactors = F, fill = T, comment.char = "", quote = "")
...
background = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/SLIPPER_background.txt", header = T, stringsAsFactors = F, sep = "\t", comment.char = "", quote = "")
# inframe, frame-unknown, out-of-strand
partners = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/SLIPPER_Partners_all.txt", header = T, stringsAsFactors = F, sep = "\t", comment.char = "", quote = "")
...
FuncAnnotChart_background = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/DAVID_background.txt", 
...
FuncAnnotChart_partners = read.table("~/Dropbox/Work_Netherlands/FGFR/FGFR2_C_trunc/Nature_figures/data/FM/DAVID_partners.txt", 
                                       header = T, sep = "\t", stringsAsFactors = F, quote = "", fill = T)
...
df_1 = df %>%
    mutate(PARTNER_label = ifelse(gene2 %in% (head(names(sort(table(df$gene2), decreasing=T)), 20)), gene2, "others"),
           PARTNER_label = factor(PARTNER_label, levels = c((head(names(sort(table(df$gene2), decreasing=T)), 20)), "others"))) %>%
